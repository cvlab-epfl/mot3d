...
def visualisation(indexes, filenames, trajectories, colors=None, crop=(slice(None,None), slice(None,None)), 
                  ...
                  output_path="./output/sequence1", output_video="sequence1.mp4", fps=25, view=None):
...
def main(config_file='',
    ...
    if use_tracklets:
        output_frames=os.path.join(output_path, "{}_{}_tracklets".format(basename_config, view))
        output_video=os.path.join(output_path, "{}_{}_tracklets.mp4".format(basename_config, view))
    else:
        output_frames=os.path.join(output_path, "{}_{}".format(basename_config, view))
        output_video=os.path.join(output_path, "{}_{}.mp4".format(basename_config, view))
...
# python visualise.py -c config/config_multiview_PETS2009S2L1.yaml